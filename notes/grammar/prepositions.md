# Italian Prepositions – Rule Summary
...
### B) Preposizioni articolate (contracted forms)
...
The two forms col and coi are still somewhat used, but in modern italian often kept separate as well (con il instead of col). 
...
**DI**
1. possession : *le chiavi della macchina*
2. origin : *vino d’Italia*
3. specification : *l’indirizzo dei genitori*
...
### in
1. countries/regions: *in Italia*
2. many institutional or enclosed places: *in banca, in ufficio, in casa (physically inside)*
3. physical location inside a specific entity:  *nella borsa*
4. transport : *in macchina*
5. often for longer periods : *in estate, nel 2024, nella mia vita*
6. abstract vs specific contrast: *in città* vs *nella città di Roma*

### da
- movement from : *vengo da Roma*
- at someone’s place : *sono da Maria*
- professional/shop : *dal medico, dal panettiere*
- duration from past until now : *studio italiano da due anni*
- purpose in some fixed expressions : *occhiali da sole, macchina da scrivere*

### con
- accompaniment / together with : *vado con Maria*
- instrument / means : *scrivo con la penna*

### su
- location on a surface : *sul tavolo*
- topic/about : *un libro su Roma*

### per
- purpose : *studio per imparare*
- recipient / destination : *un regalo per te*
- duration (completed action) : *ho studiato per due anni*
- cause / reason : *l’ho fatto per amore*

### tra/fra
- between : *tra Roma e Milano*
...
Some adjectives require a specific preposition:
- *contento di*
- *interessato a*
- *pronto per*
- *stanco di*
...
Italian keeps the preposition before *cui*:
- *la città in cui vivo*
- *la persona con cui parlo*
- *il motivo per cui*

### Preposition + infinitive structures
- *prima di fare*
- *dopo aver fatto*
- *senza dire*
...
- Verb + preposition selection: some verbs require *a* (*imparare a fare, iniziare a parlare*), others require *di* (*smettere di fare, finire di parlare*).
